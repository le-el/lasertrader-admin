                  ...
                  {accounts.map((account) => (
                    <TableRow key={account.id}>
                      <TableCell style={{ textAlign: 'center' }}>
                        {account.id.toString().padStart(8, '0')}
                      </TableCell>
                      <TableCell style={{ textAlign: 'center' }}>
        ...
        >
          ...
          <DialogContent>
            <Select
              ...
              onChange={(e) =>
                handleNewUserChange('companyEmail', e.target.value)
              }
            ...
            {errors.companyEmail && (
              <Typography color="error">{errors.companyEmail}</Typography>
            )}
            ...
            <TextField
              ...
              onChange={(e) => handleNewUserChange('balance', e.target.value)}
            ...
            <TextField
              ...
              onChange={(e) => handleNewUserChange('leverage', e.target.value)}
            ...
            {errors.leverage && (
              <Typography color="error">{errors.leverage}</Typography>
            )}
          </DialogContent>
          <DialogActions>
            <Button
