      ...
      <List>
        ...
        >
          ...
          <ListItemText
            primary="Users"
            style={{
              fontWeight: selectedItem === '/userManagement' ? 'bold' : 'normal'
            }}
          />
        </ListItem>
        <ListItem
          onClick={() => handleNavigation('/apiManagement')}
          selected={selectedItem === '/apiManagement'}
          sx={{
            cursor: 'pointer',
            '&:hover': {
              fontWeight: 'bold',
        ...
        >
          ...
          <ListItemText
            primary="API"
            style={{
              fontWeight: selectedItem === '/apiManagement' ? 'bold' : 'normal'
            }}
          />
        </ListItem>
        <ListItem
        ...
        >
          ...
          <ListItemText
            ...
            style={{
              fontWeight:
                selectedItem === '/companyManagement' ? 'bold' : 'normal'
            }}
          />
        </ListItem>
        <ListItem
        ...
        >
          ...
          <ListItemText
            ...
            style={{
              fontWeight:
                selectedItem === '/symbolManagement' ? 'bold' : 'normal'
            }}
          />
        </ListItem>
        <ListItem
        ...
        >
          ...
          <ListItemText
            ...
            style={{
              fontWeight:
                selectedItem === '/positionManagement' ? 'bold' : 'normal'
            }}
          />
        </ListItem>
        <ListItem
